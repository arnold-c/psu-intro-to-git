...
> **Note:** if you use the GitKraken client ([detailed below](#connecting-gitkraken-with-github)), you can use the instructions in their documentation to create and pass the SSH keys directly to GitHub. This assumes you have linked GitKraken to your GitHub account.
...
If you would like to manually create your SSH keys, you can do so using the instructions [linked above](#linking-git-to-github), and then use the "Browse for Private/Public SSH Key" buttons to point to the location you saved your SSH keys.
